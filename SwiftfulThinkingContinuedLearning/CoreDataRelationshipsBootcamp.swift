...
//        request.predicate = filter
    ...
    func getEmployees(forBusines business: BusinessEntity) {
        let request = NSFetchRequest<EmployeeEntity>(entityName: "EmployeeEntity")
...
//        newBusiness.employees = [employees[1]]
    ...
    func addDepartment() {
        ...
        newDepartment.buisnesses = [businesses[0],businesses[2],businesses[3]]
        newDepartment.addToEmployees(employees[1])
//        newDepartment.buisnesses = [businesses[0]]
//        newDepartment.employees = [employees[1]]  OR
//        newDepartment.addToEmployees(employees[1])
        save()
    }
            ...
            NavigationStack {
                ScrollView{
                    VStack(spacing: 20) {
                        Button {
                            vm.deleteDepartment()
//                            vm.getEmployees(forBusines: vm.businesses[2])
                        } label: {
                            Text("Perform Action")
